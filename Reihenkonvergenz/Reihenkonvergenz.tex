...
\begin{question}
 Untersuchen Sie die folgenden Reihen auf Konvergenz: $\sum_{k=0}^\infty 2^k/k!$, $\sum_{k=0}^\infty k^2/(k^3 + 5)$ und $\sum_{k=0}^\infty k^2/2^k$.
\end{question}
\begin{solution}
 Es ist
 \[
...
\begin{solution}
 ...
 \begin{align*}
  ...
  &= q x + \frac{q}{1-q}.
 \end{align*}
 Durch Umstellen ergibt sich, dass $x = q/(1-q)^2$.
\end{solution}
...
\begin{question}
 Es seien $\sum_{k=0}^\infty a_k$ und $\sum_{k=0}^\infty b_k$ konvergente Reihen. Zeigen Sie, dass wenn eine der beide Reihen schon absolut konvergiert, auch $\sum_{k=0}^\infty a_k b_k$ absolut konvergiert. Was ist, wenn keine der beiden absolut konvergiert?
\end{question}
